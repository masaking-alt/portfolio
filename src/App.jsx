...
function CliHomeScreen() {
  ...
  return (
    <div className="space-y-6 py-2">
      ...
      <div className="grid gap-7 rounded-xl border border-white/[0.14] bg-white/[0.025] px-4 py-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] lg:grid-cols-[minmax(0,1.05fr)_minmax(280px,0.95fr)] lg:px-5 lg:py-5">
        <section className="min-w-0">
          ...
          <div className="mt-4 max-h-[420px] overflow-auto custom-scrollbar">
              <TerminalAsciiBlock
                lines={portraitLines}
                className="w-max min-w-full text-[2.8px] leading-[0.9] text-[#f0b186] sm:text-[3.2px] md:text-[3.8px]"
              />
          </div>
        ...
        <div className="min-w-0 space-y-4 border-t border-white/[0.1] pt-5 lg:border-l lg:border-t-0 lg:pl-7 lg:pt-0">
          <section>
