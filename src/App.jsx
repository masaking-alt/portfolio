...
function Home() {
  return (
    <div>
      ...
      <section id="about">
        <h2>About</h2>
                                <p>こんにちは、まさきんぐです。高知大学で情報科学を専攻している大学生です。 バイブコーディングにハマっていて、日々学んだことを形にしています。昔からプログラミングに興味があり、AIを利用することでそのハードルが下がったため、web制作に挑戦しています。</p>
        <p>好きなゲームはモンハンで、特に3DSのシリーズが好きです。好きなアーティストはVaundy。アニメ、マンガ、映画を見るのも好きです。インスタで日常を上げています。気軽に覗いてみてください。</p>
        <p>また、このサイトは以下の技術を使って製作しました。</p>
